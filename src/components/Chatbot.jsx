...
const Chatbot = () => {
  ...
  const generateResponse = async (query, context) => {
    ...
    try {
      ...
      const prompt = `You are an expert Polaris optimizer consultant helping sellers optimize their product listings and enhance retail Supply chain management. Based on the following context and user query, provide specific, actionable advice.
...
User Query: ${query}
 ...
 Please provide: anwer in maximum 200 words just look at the product in knowledge base productdata about which seller asked and then directly give improvement reagarding it based on  polaris algorithm `;
